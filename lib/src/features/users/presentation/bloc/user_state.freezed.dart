...
@useResult
$Res call({
 PaginatedState<User> users
});


$PaginatedStateCopyWith<User, $Res> get users;
...
$PaginatedStateCopyWith<User, $Res> get users {
  ...
  return $PaginatedStateCopyWith<User, $Res>(_self.users, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PaginatedState<User> users)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PaginatedState<User> users)  $default,) {final _that = this;
switch (_that) {
case _UserState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PaginatedState<User> users)?  $default,) {final _that = this;
switch (_that) {
case _UserState() when $default != null:
return $default(_that.users);case _:
  return null;
...
class _UserState implements UserState {
  const _UserState({this.users = const PaginatedState<User>()});
  

@override@JsonKey() final  PaginatedState<User> users;
...
@override $PaginatedStateCopyWith<User, $Res> get users;
